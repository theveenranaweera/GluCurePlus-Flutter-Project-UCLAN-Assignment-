...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Widget build(BuildContext context) {
    return PopScope(
      // Disable normal pop so pressing the back button won’t
      // removing this route from the Navigator stack.
      canPop: false,

      // Called _after_ a pop attempt has been made.
      // If canPop == false, the pop is canceled, so didPop == false.
